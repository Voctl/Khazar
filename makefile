...
run: iso
	qemu-system-x86_64 -cdrom khazar.iso -m 2048 -display gtk -audiodev pa,id=speaker -machine pcspk-audiodev=speaker -d int,cpu_reset -no-reboot -no-shutdown -D qemu.log
